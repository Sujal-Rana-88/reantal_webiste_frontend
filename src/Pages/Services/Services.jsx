    ...
    <>
      ...
      <div className="flex flex-col items-center bg-gray-100 min-h-screen py-20">
        ...
        <div className="mt-12 w-full px-4 md:px-0 md:w-3/4 lg:w-2/3">
          <h2 className="text-2xl font-semibold text-gray-800">Rent a Game</h2>
        ...
        <div className="mt-16 w-full px-4 md:px-0 md:w-3/4 lg:w-2/3">
          <h2 className="text-2xl font-semibold text-gray-800">Lend a Game</h2>
          <p className="mt-4 text-gray-600 leading-relaxed">
        ...
        <div className="mt-16 w-full px-4 md:px-0 md:w-3/4 lg:w-2/3">
          <h2 className="text-2xl font-semibold text-gray-800">Secure Transactions</h2>
          <p className="mt-4 text-gray-600 leading-relaxed">
        ...
        <div className="mt-16 w-full px-4 md:px-0 md:w-3/4 lg:w-2/3">
          <h2 className="text-2xl font-semibold text-gray-800">Game Categories</h2>
          <p className="mt-4 text-gray-600 leading-relaxed">
        ...
        <div className="mt-16 w-full px-4 md:px-0 md:w-3/4 lg:w-2/3">
          <h2 className="text-2xl font-semibold text-gray-800">User Ratings & Reviews</h2>
          <p className="mt-4 text-gray-600 leading-relaxed">
